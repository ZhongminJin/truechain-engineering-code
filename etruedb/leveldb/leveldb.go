...
func (db *LevelDBDatabase) NewBatch() etruedb.Batch {
	return &levelDBBatch{
		db: db.db,
		b:  new(leveldb.Batch),
	}
...
func (db *LevelDBDatabase) NewIterator() etruedb.Iterator {
	return db.NewIteratorWithPrefix(nil)
}

// NewIteratorWithPrefix creates a binary-alphabetical iterator over a subset
// of database content with a particular key prefix.
func (db *LevelDBDatabase) NewIteratorWithPrefix(prefix []byte) etruedb.Iterator {
